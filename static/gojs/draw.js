function init() {
  ...
  myDiagram.nodeTemplateMap.add("Router",
    $(go.Node, "Table",
      ...
      $(go.Panel, "Auto",
        ...
        $(go.Shape, "Circle",
          { fill: "#0d9aba", stroke: null, strokeWidth: 0,
    ...
    myDiagram.nodeTemplateMap.add("L3Switch",
  $(go.Node, "Table",
    { locationObjectName: "BODY",
      locationSpot: go.Spot.Center,
      selectionObjectName: "BODY",
    ...
    $(go.Panel, "Auto",
      { row: 1, column: 1, name: "BODY",
        stretch: go.GraphObject.Fill },
      $(go.Shape, "Rectangle",
        { fill: "#006e87", stroke: null, strokeWidth: 0,
          minSize: new go.Size(56, 56) }),
      $(go.TextBlock,
        { margin: 10, textAlign: "center", font: "14px  Segoe UI,sans-serif", stroke: "white", editable: true },
        new go.Binding("text", "name").makeTwoWay())
  ...
  myDiagram.nodeTemplateMap.add("L2Switch",
    $(go.Node, "Table",
      { locationObjectName: "BODY",
        locationSpot: go.Spot.Center,
        selectionObjectName: "BODY",
      ...
      $(go.Panel, "Auto",
        { row: 1, column: 1, name: "BODY",
          stretch: go.GraphObject.Fill },
        $(go.Shape, "Square",
          { fill: "#155170", stroke: null, strokeWidth: 0,
            minSize: new go.Size(56, 56) }),
        $(go.TextBlock,
          { margin: 10, textAlign: "center", font: "14px  Segoe UI,sans-serif", stroke: "white", editable: true },
          new go.Binding("text", "name").makeTwoWay())
          ...
          itemTemplate:
            $(go.Panel,
              { _side: "bottom",
                ...
                contextMenu: portMenu },
              new go.Binding("portId", "portId"),
              new go.Binding("portType","portType"),
              $(go.Shape, "Rectangle",
                { stroke: null, strokeWidth: 0,
                  desiredSize: portSize,
                  margin: new go.Margin(0, 1) },
    ...
    myPalette.model.nodeDataArray = [
      {"category": "Router","name":"","leftArray":[], "rightArray":[], "topArray":[], "bottomArray":[]},
      {"category": "L3Switch","name":"","leftArray":[], "rightArray":[], "topArray":[], "bottomArray":[]},
      {"category": "L2Switch","name":"","leftArray":[], "rightArray":[], "topArray":[], "bottomArray":[]},
    ];
...
function addPort(side) {
  var e = document.getElementById("PortType");
  ...
  myDiagram.selection.each(function(node) {
    ...
    var k = 0
    while (node.findPort("left"+ k.toString()) !== node) {
      k++ ;
      p++ ;
     if (p%10==0){
        p = 0 ;
    ...
    k=0
    while (node.findPort("right"+ k.toString()) !== node) {
      k++ ;
      p++ ;
     if (p%10==0){
        p = 0 ;
    ...
    k=0 ;
    while (node.findPort("top"+ k.toString()) !== node) {
      k++ ;
      p++ ;
     if (p%10==0){
        p = 0 ;
    ...
    k = 0 ;
    while (node.findPort("bottom"+ k.toString()) !== node) {
      k++ ;
      p++ ;
     if (p%10==0){
        p = 0 ;
    ...
    port = type+s.toString()+"/"+p.toString();
    p++ ;
